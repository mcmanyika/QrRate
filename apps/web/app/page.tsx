    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden transition-colors duration-200">
      ...
      <section className="container mx-auto px-4 py-10 md:py-14 relative z-10">
        <div className="text-center max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex justify-center items-center animate-scale-in mt-6" style={{ animationDelay: '0.6s' }}>
            <a
              href={isLoggedIn ? "/dashboard" : "/auth/login"}
              className="group relative px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-semibold text-base hover:from-blue-700 hover:to-blue-800 transition-all duration-300 hover:scale-105 transform tracking-tight"
            >
              <span className="relative z-10">{isLoggedIn ? "Go to Dashboard" : "Sign In"}</span>
            </a>
          </div>
        </div>
      </section>
