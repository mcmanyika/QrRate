...
do $$ begin
  if not exists (
    ...
    and policyname = 'expense_select_own'
  ) then
...
do $$ begin
  if not exists (
    ...
    where schemaname = 'public' 
    and tablename = 'expense' 
    and policyname = 'expense_insert_own'
  ) then
...
do $$ begin
  if not exists (
    ...
    where schemaname = 'public' 
    and tablename = 'expense' 
    and policyname = 'expense_update_own'
  ) then
...
do $$ begin
  if not exists (
    ...
    where schemaname = 'public' 
    and tablename = 'expense' 
    and policyname = 'expense_delete_own'
  ) then
...
do $$ begin
  if not exists (
    select 1 from pg_policies 
    where schemaname = 'public' 
    and tablename = 'expense_approval' 
    and policyname = 'expense_approval_select_own'
  ) then
...
do $$ begin
  if not exists (
    ...
    where schemaname = 'public' 
    and tablename = 'expense_approval' 
    and policyname = 'expense_approval_insert_own'
  ) then
